...
Benign events are selected from a pool of 7 lambda functions (web×3, firewall×2, dns×1, inbound_block×1) using `random.choice`. The effective weights are: web 3/7, firewall 2/7, dns 1/7, inbound_block 1/7.
